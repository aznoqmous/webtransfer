...
INSERT INTO "new_Archive" ("createdAt", "downloadCount", "fileSize", "filesCount", "id", "startedAt", "title", "userId", "uuid") SELECT "createdAt", "downloadCount", "fileSize", "filesCount", "id", "startedAt", "title", "userId", "uuid" FROM "Archive";
DROP TABLE "Archive";
